...
[Five Card Draw rules](https://en.wikipedia.org/wiki/Five-card_draw).
...
## Some notes
- CardRank, CardSuit and GameType is enums for more type safety, but static method valueOfLabel has O(N) complexity
- Supports only five-card-draw game type
- Bad implementation of FiveCardDrawSolver.toOutputView
- No specific rules to build and run it